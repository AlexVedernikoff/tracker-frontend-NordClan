  ...
  _createClass(Select, [
    ...
    },
    {
      ...
      value: function getValueArray(value) {
        ...
        var props =
          (typeof nextProps === 'undefined' ? 'undefined' : _typeof(nextProps)) === 'object' ? nextProps : this.props;
        if (props.multi) {
    ...
    },
    {
      ...
      value: function focusAdjacentOption(dir) {
        ...
        if (!this.state.isOpen) {
          var newState = {
            focusedOption:
              this._focusedOption || (options.length ? options[dir === 'next' ? 0 : options.length - 1].option : null),
            isOpen: true
          };
      ...
      value: function renderValue(valueArray, isOpen) {
        ...
        if (!valueArray.length) {
          ...
          return showPlaceholder
            ? _react2.default.createElement('div', { className: 'Select-placeholder' }, this.props.placeholder)
            : null;
        }
        ...
        if (this.props.multi) {
          return valueArray.map(function(value, i) {
            return _react2.default.createElement(
              ...
              renderLabel(value, i),
              _react2.default.createElement('span', { className: 'Select-aria-only' }, '\xA0')
            );
          });
      ...
      value: function renderInput(valueArray, focusedOptionIndex) {
        ...
        if (this.props.autosize) {
          return _react2.default.createElement(
            ...
            _extends({ id: this.props.id }, inputProps, { className: className, minWidth: '5' })
          );
        }
        return _react2.default.createElement(
          'div',
    ...
    },
    {
      ...
      value: function filterOptions(excludeOptions) {
        ...
        if (this.props.filterOptions) {
          ...
          var filterOptions =
            typeof this.props.filterOptions === 'function' ? this.props.filterOptions : _defaultFilterOptions2.default;
