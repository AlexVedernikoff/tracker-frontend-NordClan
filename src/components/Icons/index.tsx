...
export const IconExternalUsers = props => (
  <SvgIcon viewBox="0 0 24 24" {...props}>
...
export const IconFileTree = props => (
  <SvgIcon viewBox="0 0 24 24" {...props}>
...
export const IconGitlab = props => (
  <SvgIcon viewBox="0 0 210 194" {...props}>
    <path d="M66.287 74.3889H143.567L166.84 2.76413C168.037 -0.921875 173.251 -0.920875 174.448 2.76413L197.72 74.3887L209.462 110.528C210.533 113.824 209.36 117.435 206.556 119.472L104.927 193.31L3.29814 119.472C0.494136 117.435 -0.678864 113.824 0.392136 110.528L12.134 74.3887L35.4062 2.76413C36.6032 -0.920875 41.8172 -0.921875 43.0142 2.76413L66.287 74.3889Z" />
  </SvgIcon>
);
...
export const IconPhoto = props => (
  <SvgIcon viewBox="0 0 512 512" {...props}>
    <path d="M490.67,106.67H365.18l-26.1-52.21A21.34,21.34,0,0,0,320,42.67H192a21.34,21.34,0,0,0-19.08,11.79l-26.1,52.21H21.33A21.33,21.33,0,0,0,0,128V448a21.33,21.33,0,0,0,21.33,21.33H490.67A21.33,21.33,0,0,0,512,448V128A21.33,21.33,0,0,0,490.67,106.67ZM256,384A106.67,106.67,0,1,1,362.67,277.33,106.79,106.79,0,0,1,256,384Zm64-106.67a64,64,0,1,1-64-64A64.07,64.07,0,0,1,320,277.33Z" />
  </SvgIcon>
);

export const IconBlock = props => (
  <SvgIcon viewBox="0 0 426.667 426.667" {...props}>
    <path
...
export const IconArrowWithTailUp = props => (
...
export const IconExclamation = props => (
  <SvgIcon viewBox="0 0 384 384" {...props}>
    ...
    <rect x="149.333" width="85.333" height="256" />
  </SvgIcon>
);

export const IconCircle = props => (
  <SvgIcon viewBox="0 0 471.612 471.612" {...props}>
    <path
...
export const IconArrowWithTailDown = props => (
  <SvgIcon viewBox="0 0 492 492" {...props}>
    <path
      d="M442.668,268.536l-16.116-16.12c-5.06-5.068-11.824-7.872-19.024-7.872c-7.208,0-14.584,2.804-19.644,7.872
...
export const IconWater = props => (
  <SvgIcon viewBox="0 0 294.465 294.465" {...props}>
    <path
